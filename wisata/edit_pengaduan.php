...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_status = $_POST['update_status']; // Ambil nilai update_status dari form
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nomorhp" name="nomorhp" value="<?php echo $row['nomorhp']; ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="pesan" name="pesan" rows="5" required><?php echo $row['pesan']; ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="update_status" name="update_status" value="<?php echo $row['update_status']; ?>">
            </div>
